    ...
    <>
      <div className="flex flex-row p-2 justify-between border-b-2 border-black">
        <div className="flex flex-row">
          <div className={todoListButtonStyle}>
          ...
          <div className={todoListButtonStyle} onClick={() => editListName()}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <div className={todoListButtonStyle} onClick={() => deleteList()}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
        ...
        <div className={todoListButtonStyle} onClick={() => showCompleted()}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
